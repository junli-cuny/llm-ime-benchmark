...
\name{Yuchun Zou$^{\ast}$, Tedd Lee$^{\S}$\thanks{Tedd Lee was supported by the CUNY Career Launch program.}, Xiaodi Fan$^{\ddagger}$, Jun Li$^{\dagger}$}
...
In this section, we present a focused analysis of our benchmark results, highlighting key performance trade-offs. As established in our methodology, our analysis concentrates on an analysis subset of models to clearly illustrate the primary findings, while the appendix reports the full model set.
...
\cmidrule(lr){2-3}
& Chinese Sentences (Error Correction Base) & {CSCD-IME Corpus} \citep{nghuyong2024cscdime}. A balanced corpus used as the basis for creating the \textit{Chinese Phonetic Error Dataset}. \\
\cmidrule(lr){2-3}
& Chinese Phonetic Error Dataset & {Ours} \citep{my_chinese_error_dataset}. 3,502 sentences with injected Pinyin and semantic errors, used for the \textit{Chinese phonetic error correction task}. \\
\midrule
...
\cmidrule(lr){2-3}
& Japanese Sentences & {Snow Simplified Corpus} \citep{snow2024simplified}. A corpus of >10,000 sentences used for the \textit{sentence generation task} and as the base for the \textit{Japanese Phonetic Error Dataset}. \\
\cmidrule(lr){2-3}
& Japanese Phonetic Error Dataset & {Ours} \citep{my_japanese_error_dataset}. >10,000 sentences with injected Romaji errors, used for the \textit{Japanese phonetic error correction task}. \\
\cmidrule(lr){2-3}
...
\begin{figure*}[h!]
    \centering
    \includegraphics[width=.99\textwidth]{../figures/csg_textsim_wl.pdf}\\
    \vspace{2mm}
    \includegraphics[width=.99\textwidth]{../figures/csg_time_wl.pdf}
...
\begin{figure*}[h!]
    \centering
    \includegraphics[width=.99\textwidth]{../figures/jsg_textsim_wl.pdf}\\
    \vspace{2mm}
    \includegraphics[width=.99\textwidth]{../figures/jsg_time_wl.pdf}
...
\begin{figure*}[h!]
    \centering
    \includegraphics[width=.99\textwidth]{../figures/cec_pinyin_textsim_noise.pdf}\\
    \vspace{2mm}
    \includegraphics[width=.99\textwidth]{../figures/cec_pinyin_time_noise.pdf}
...
\begin{figure*}[h!]
    \centering
    \includegraphics[width=.99\textwidth]{../figures/jec_char_textsim_noise.pdf}\\
    \vspace{2mm}
    \includegraphics[width=.99\textwidth]{../figures/jec_char_time_noise.pdf}
...
\begin{figure*}[h!]
    \centering
    \includegraphics[width=.99\textwidth]{../figures/jwg_kanji_textsim_wl.pdf} \\
    \vspace{2mm}
    \includegraphics[width=.99\textwidth]{../figures/jwg_hira_textsim_wl.pdf} \\
    \vspace{2mm}
    \includegraphics[width=.99\textwidth]{../figures/jwg_kata_textsim_wl.pdf}
