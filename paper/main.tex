...
\cmidrule(lr){2-3}
& Chinese Phonetic Error Dataset & \textbf{Ours} \citep{my_chinese_error_dataset}. 3,502 sentences with injected Pinyin and semantic errors, used for the \textit{Chinese phonetic error correction task}. \\
\midrule
...
\cmidrule(lr){2-3}
& Japanese Phonetic Error Dataset & \textbf{Ours} \citep{my_japanese_error_dataset}. >10,000 sentences with injected Romaji errors, used for the \textit{Japanese phonetic error correction task}. \\
\cmidrule(lr){2-3}
